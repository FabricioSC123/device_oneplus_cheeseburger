...
import com.radiant.device.DeviceSettings.Constants;
import com.radiant.device.DeviceSettings.DeviceSettings;
import com.radiant.device.DeviceSettings.R;
...
public class KeyHandler implements DeviceKeyHandler {
    ...
    private Context getResContext(Context context) {
        Context resContext;
        try {
            resContext = context.createPackageContext("com.radiant.device.DeviceSettings",
